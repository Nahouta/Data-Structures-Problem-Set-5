...
public class Graph {
    ...
    //         while (eb != null) { //Second loop: Searches for an unexplored branch
    //             if (eb.end.encountered) {
    //                 eb = eb.next;
    //             }
    //             else {
    //                 Edge e = eb;    //A non encountered branch has been discovered, we pass it for depth exploration
    //                 Vertex w = e.end;
    //                 Vertex p = v;

    //                 while (e != null) { //Third Loop: Goes down the branch
    //                     w = e.end;
    //                     if (!w.encountered) {
    //                         w.encountered = true;
    //                         w.parent = p;
    ...
    //                     //Check for the neighbors to back up onto
    //                 }
    ...
    // }
        ...
        private static void dfTravIter (Vertex origin) {
            //We create a stack to stock the vertices before reprinting them
            ...
            while (!stack.isEmpty()) {
                ...
                if (!v.done) {
                    //Has the Vertex been visited? If not, we visit it.
                    System.out.println(v.id);
                    v.done = true;
